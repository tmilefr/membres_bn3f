...
<?php
echo form_open(base_url('Taux_controller/'.$this->render_object->_get('form_mod')), array('class' => '', 'id' => 'edit') , array('form_mod'=>$this->render_object->_get('form_mod'),'id'=>$id) );
//champ obligatoire
...
<div class="card" >
	<div class="card-header">
		<?php echo $this->lang->line('Taux_controller_'.$this->render_object->_get('form_mod'));?>
	</div>	
  	<div class="card-body">
		<div class="form-row">
